package net.xipfs.hunter.thirdpart.coingecko.impl;

import net.xipfs.hunter.thirdpart.coingecko.CoinGeckoApiService;
import net.xipfs.hunter.thirdpart.coingecko.CoinGeckoApi;
import net.xipfs.hunter.thirdpart.coingecko.domain.*;
import net.xipfs.hunter.thirdpart.coingecko.domain.Coins.*;
...
import net.xipfs.hunter.thirdpart.coingecko.domain.Exchanges.*;
