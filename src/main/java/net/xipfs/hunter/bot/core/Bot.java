...
import net.xipfs.hunter.bot.api.ApiResult;
import net.xipfs.hunter.bot.api.support.*;
import net.xipfs.hunter.bot.config.BotConfig;
import net.xipfs.hunter.bot.contact.support.Friend;
import net.xipfs.hunter.bot.exception.BotException;
